 ...
 * params.put("shopId", new String[]{"fhu478fay7fs7aegthaea"});
 * getLog().info(getRestults("/compDrugCollect/getCollectList.do", HttpMethod.GET, params));
 */
...
//	
//	/**��ȡController ���صĽ��*/
//	public String getRestults (String url,HttpMethod method,Map<String,String[]> params) throws UnsupportedEncodingException, Exception {
