...
public class LocalMac {
			...
			synchronized (Mac.class) {
				if (instanse == null || instanse.length() == 0) {
					...
					try {
						...
						label: while (netInterfaces.hasMoreElements()) {
	...
	public static void main(String[] args) throws IOException {
		JOptionPane.showMessageDialog(null, LocalMac.localIPAddress() + "/" + Mac.getInstanse(), "本机IP/MAC地址为：",
		...
		// System.err.println("IP:" + LocalMac.localIPAddress() + " MAC:" +
		// Mac.getInstanse());
		fw.close();
	}
}
